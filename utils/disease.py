disease_dic = {
    'Apple___Apple_scab': """ <br/>Disease: Apple Scab<br/>
        <br/> Cause of disease:
    ...
    'Apple___Cedar_apple_rust': """ <br/>Disease: Cedar Apple Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Common_rust_': """ (maize) <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """ (maize) <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___healthy': """ (maize) <br/>Disease: No disease<br/>
    ...
    'Soybean___healthy': """  <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Strawberry___healthy': """  Strawberry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Tomato___healthy': """ <br/>Disease: No disease<br/>
